...
namespace ConsoleApp4
{
	...
	class Window3D : GameWindow
	{
		...
		private List<Objectoid> raintOfObject;
		...
		public Window3D() : base(1280, 768, new GraphicsMode(32, 24, 0, 8))
		{
			...
			raintOfObject = new List<Objectoid>();
		...
		protected override void OnUpdateFrame(FrameEventArgs e)
		{
			...
			{
				raintOfObject.Add(new Objectoid(GRAVITY));
			}
			...
			foreach (Objectoid obj in raintOfObject)
			{
		...
		private void DisplayHelp()
		{
			...
			Console.WriteLine(" (Mouse left click) - spawn la obiecte");
			Console.WriteLine(" (Mouse right click) - sterge obiectele");
		}
